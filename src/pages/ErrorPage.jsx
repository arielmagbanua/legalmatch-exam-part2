    ...
    <div className="flex items-center justify-center w-full min-h-[70vh] text-gray-900 my-12 px-4">
      <div className="flex flex-col items-center w-full gap-8">
        ...
        <div className="flex flex-row justify-between gap-8">
          <Link className="bg-gray-400 rounded-2xl flex justiy-center items-center px-5 py-4 text-xl text-black hover:bg-indigo-500 hover:text-white" to={-1}>
            Previous Page
          </Link>
          <Link className="bg-gray-400 rounded-2xl flex justiy-center items-center px-5 py-4 text-xl text-black hover:bg-green-500 hover:text-white" to='/'>
            Home Page
          </Link>
        </div>
      </div>
